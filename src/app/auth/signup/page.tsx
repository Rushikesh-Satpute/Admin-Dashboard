...
const SignUp: React.FC = () => {
  ...
  return (
    <div className="p-8 items-center justify-center flex flex-col">
      ...
      <div className="rounded-sm w-[80%] border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center justify-center">
          <div className="hidden w-full xl:block xl:w-[45%]">
            <div className="px-10 py-17.5 text-center">
              ...
              <p className="2xl:px-20">
                Create an account and explore the future, <br />
                Sign up to be a part of something great.
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-[55%] xl:border-l-2">
