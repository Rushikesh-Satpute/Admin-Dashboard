...
const SignIn: React.FC = () => {
  ...
  const onLogin = async () => {
    try {
      ...
      if (error.response && error.response.data?.error === 'User does not exist in DB') {
  ...
  return (
    <div className="p-8 h-screen flex-col items-center justify-center flex">
      <Breadcrumb pageName="Sign In" />
      <div className="rounded-sm border w-[90%] border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">

        {error && <div className="w-full text-white m-2">
          <div className="w-1/2 flex items-center rounded-lg bg-red-500 justify-between px-6 py-4 mx-auto">
            <div className="flex">
            ...
            <button onClick={() => setError('')} className="p-1 transition-colors duration-300 transform rounded-md hover:bg-opacity-25 hover:bg-gray-600 focus:outline-none">
        ...
        <div className="flex items-center justify-center">
          <div className="hidden w-full xl:block xl:w-[45%]">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20">
                Welcome Back! Log in to continue your journey, <br /> Access your account and stay connected.
              </p>
